...
function App() {
  ...
  // Các state và ref cũ của bạn (Giữ nguyên)
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className="bg-[#1a0505] text-amber-50 transition-colors duration-500">
        {/* Navigation - Đã chuyển sang theme Đỏ/Vàng */}
        <nav className="sticky top-0 z-50 border-b border-amber-500/20 bg-[#1a0505]/90 backdrop-blur-xl shadow-sm transition-all duration-300">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-red-700 to-red-900 rounded-lg flex items-center justify-center shadow-lg border border-amber-500/30">
                  <Home className="w-6 h-6 text-amber-100" />
                </div>
                <h1 className="text-xl font-black text-amber-400 tracking-tighter">
                  MLN131
                </h1>
              </div>
                ...
                {navItems.map((item) => (
                   ...
                   className={`px-3 py-2 rounded-lg text-xs font-bold transition-all ${
                     activeSection === item.id
                       ? 'bg-[#450a0a] text-amber-400 border border-amber-500/30'
                       : 'text-gray-400 hover:bg-[#2b0a0d] hover:text-amber-100'
                   }`}
                 >
                   {item.label}
                 </button>
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-[#2b0a0d] hover:bg-[#3d0e12] border border-amber-900/30 transition-all duration-300 shadow-md hover:shadow-lg"
        ...
        {/* Hero Section */}
        <section id="hero" className="relative min-h-screen bg-gradient-to-br from-[#1a0505] via-[#450a0a] to-[#1a0505] flex items-center justify-center overflow-hidden pt-20">
          {/* Animated background elements - Đã đổi màu */}
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-amber-500 rounded-full filter blur-3xl opacity-10 animate-pulse"></div>
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-red-600 rounded-full filter blur-3xl opacity-10 animate-pulse" style={{animationDelay: '2s'}}></div>
          </div>
          ...
          <div className="relative z-20 container mx-auto px-6 text-center max-w-4xl">
            <div className="mb-8 animate-fade-in">
              <Badge className="px-6 py-3 bg-amber-500/90 text-[#450a0a] text-base font-bold shadow-lg hover:shadow-xl transition-shadow border border-amber-300">
            ...
            <p className="text-2xl md:text-3xl text-amber-100 mb-6 font-semibold drop-shadow-md">
              Trong Thời kỳ Quá độ Lên Chủ nghĩa Xã hội
            </p>

            <div className="flex justify-center gap-2 mb-12">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="h-1.5 bg-gradient-to-r from-amber-400 to-red-500 rounded-full" style={{width: (i === 1 ? 40 : 24) + 'px'}}></div>
              ))}
            </div>

            <p className="text-lg text-red-100/90 max-w-2xl mx-auto leading-relaxed mb-12 font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-amber-500 to-amber-600 text-[#450a0a] hover:from-amber-400 hover:to-amber-500 px-8 py-6 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
              ...
              <Button 
                size="lg" 
                className="border-2 border-amber-200/50 text-white hover:bg-white/10 px-8 py-6 text-lg font-bold shadow-lg hover:shadow-xl transition-all duration-300"
        ...
        {/* Section 1: Mác-Lênin - Đã đổi màu Card */}
        <section id="mac-lenin" className="relative py-24 bg-[#1a0505]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-black mb-4 bg-gradient-to-r from-red-400 to-amber-400 bg-clip-text text-transparent">
                QUAN ĐIỂM MÁC-LÊNIN
              </h2>
              <p className="text-red-200/80">Nguồn gốc, Bản chất & Tính chất của Tôn giáo</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                {/* Card Bản chất */}
                <div className="bg-[#2b0a0d] rounded-3xl p-8 border border-amber-500/20 shadow-xl" data-reveal>
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-xl bg-red-900/50 flex items-center justify-center text-red-400 border border-red-500/20">
                      <BookOpen size={24} />
                    </div>
                    <h3 className="text-2xl font-bold text-amber-50">Bản chất</h3>
                  </div>
                  <p className="text-red-100/90 leading-relaxed bg-[#150505]/50 p-6 rounded-2xl border border-white/5">
                ...
                <div className="bg-[#2b0a0d] rounded-3xl p-8 border border-amber-500/20 shadow-xl" data-reveal>
                    <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 rounded-xl bg-amber-900/30 flex items-center justify-center text-amber-500 border border-amber-500/20">
                      <Zap size={24} />
                    </div>
                    <h3 className="text-2xl font-bold text-amber-50">3 Nguồn gốc</h3>
                  </div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="flex flex-col p-4 rounded-2xl bg-[#3f0f12] hover:bg-[#501317] transition-colors border border-white/5">
                        <span className={`font-bold ${item.c} mb-1`}>{item.t}</span>
                        <span className="text-sm text-red-100/70">{item.d}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {/* Cột Phải: Tính chất */}
              <div className="bg-[#2b0a0d] rounded-3xl p-8 border border-amber-500/20 shadow-xl h-full flex flex-col" data-reveal>
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 rounded-xl bg-emerald-900/30 flex items-center justify-center text-emerald-500 border border-emerald-500/20">
                    <Shield size={24} />
                  </div>
                  <h3 className="text-2xl font-bold text-amber-50">Tính chất</h3>
                </div>
                <div className="space-y-3 flex-grow">
                  {[
                    ...
                    { t: 'Tính Chính trị', d: 'Thường bị lợi dụng cho mục đích chính trị', c: 'text-amber-400' }
                  ].map((item, i) => (
                    <div key={i} className="flex flex-col p-4 rounded-2xl bg-[#3f0f12] hover:bg-[#501317] transition-colors border border-white/5">
                      <span className={`font-bold ${item.c} mb-1`}>{item.t}</span>
                      <span className="text-sm text-red-100/70">{item.d}</span>
              ...
              {/* Tính chất - Grid Icon */}
              <div className="col-span-1 md:col-span-2 group relative bg-gradient-to-br from-[#7f1d1d] to-[#450a0a] rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden text-white w-full border border-amber-500/20" data-reveal>
                ...
                <div className="relative w-full">
                  <div className="flex items-start gap-4 mb-8 w-full">
                    <div className="p-3 bg-white/10 rounded-lg flex-shrink-0 border border-white/10">
                      <Shield className="w-6 h-6 text-amber-300" />
                    </div>
                    <h3 className="text-3xl font-bold break-words text-amber-100">Tính chất của Tôn giáo</h3>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                    {[
                      ...
                      <div key={i} className="bg-black/20 backdrop-blur-sm border border-amber-500/10 rounded-xl p-6 hover:bg-black/30 transition-all duration-300 w-full break-words whitespace-normal">
                        <p className="text-3xl mb-2 break-words">{item.icon}</p>
                        <h4 className="text-lg font-bold mb-2 break-words text-amber-200">{item.title}</h4>
                        <p className="text-red-50/80 text-sm leading-relaxed break-words whitespace-normal">{item.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="col-span-1 md:col-span-2 group relative bg-gradient-to-br from-[#7f1d1d] to-[#450a0a] rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden text-white w-full border border-amber-500/20" data-reveal>
                <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full -mr-48 -mt-48 group-hover:scale-110 transition-transform duration-300"></div>
                <div className="relative w-full">
                  <h3 className="text-3xl font-bold mb-8 break-words text-amber-100">4 Nguyên tắc Giải quyết Tôn giáo</h3>
                  <div className="space-y-5 w-full">
                    {[
                      ...
                      <div key={item.num} className="flex items-start gap-6 pb-5 border-b border-amber-500/10 last:border-b-0 last:pb-0 w-full hover:bg-white/5 p-4 rounded-lg transition-all duration-300">
                        <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-amber-500 to-red-600 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg flex-shrink-0 border-2 border-amber-300">
                          {item.num}
                        </div>
                        <div className="min-w-0 flex-1 pt-2">
                          <p className="text-red-50/90 break-words whitespace-normal">{item.text}</p>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        {/* Section 2: Tôn giáo ở Việt Nam - Đã đổi màu Card */}
        <section id="ton-giao-vietnam" className="relative py-24 bg-[#1a0505]">
          <div className="absolute top-1/3 right-0 w-80 h-80 bg-amber-600/10 rounded-full blur-[100px]"></div>

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-black mb-4 bg-gradient-to-r from-amber-500 to-red-500 bg-clip-text text-transparent">
                TÔN GIÁO Ở VIỆT NAM
              </h2>
              <p className="text-red-200/80">Và Chính sách Tôn giáo của Đảng, Nhà nước</p>
            </div>

            <div className="space-y-6">
              {/* Card 1: Tôn giáo ở Việt Nam */}
              <div className="group p-8 bg-[#2b0a0d] hover:bg-[#3d0e12] rounded-3xl border border-amber-500/20 transition-all duration-300 shadow-lg overflow-hidden" data-reveal>
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 bg-blue-900/30 rounded-2xl border border-blue-500/20">
                    <Globe size={32} className="text-blue-400" />
                  </div>
                  <h3 className="text-2xl font-bold text-amber-50">Tôn giáo ở Việt Nam</h3>
                </div>
                <div className="space-y-4 pl-16">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-4">
                      <div className={`p-2.5 ${item.bg} ${item.color} rounded-lg w-fit flex-shrink-0 mt-1 border border-white/5`}>
                        <item.icon size={20} />
                      </div>
              ...
              <div className="group p-8 bg-[#2b0a0d] hover:bg-[#3d0e12] rounded-3xl border border-amber-500/20 transition-all duration-300 shadow-lg overflow-hidden" data-reveal>
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 bg-purple-900/30 rounded-2xl border border-purple-500/20">
                    <Shield size={32} className="text-purple-400" />
                  </div>
                  <h3 className="text-2xl font-bold text-amber-50">Quan điểm</h3>
                </div>
                <p className="text-red-100/90 leading-relaxed pl-16">
                  Tín ngưỡng, tôn giáo là nhu cầu tinh thần của một bộ phận nhân dân, sẽ tồn tại lâu dài.
                </p>
              </div>

              {/* Card 3: Chính sách cốt lõi */}
              <div className="group p-8 bg-gradient-to-br from-[#7f1d1d] to-[#991b1b] hover:from-[#991b1b] hover:to-[#7f1d1d] rounded-3xl shadow-lg overflow-hidden transition-all duration-300 border border-amber-500/30" data-reveal>
                <div className="flex items-start gap-6 mb-6">
                  <div className="p-4 bg-white/10 rounded-2xl flex-shrink-0 border border-white/10">
                    <Zap size={32} className="text-amber-200" />
                  </div>
                ...
                <div className="space-y-4 pl-16 text-white/90">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <span className="flex-shrink-0 font-bold text-amber-300 mt-0.5">{i + 1}.</span>
                      <span className="text-sm text-red-50">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* Section 3: Quan hệ Dân tộc & Tôn giáo - ĐÃ SỬA MÀU */}
        <section id="quan-he-dan-toc" className="relative py-24 bg-gradient-to-b from-red-50 to-white dark:from-[#1a0505] dark:to-[#0f0505]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="text-center mb-20">
              <h2 className="text-5xl md:text-6xl font-black mb-4 bg-gradient-to-r from-[#991b1b] to-red-600 dark:from-red-400 dark:to-amber-300 bg-clip-text text-transparent">
            ...
            <div className="space-y-8">
              {/* Sự gắn kết */}
              <div className="group relative bg-white dark:bg-[#2b0a0d] rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-red-100 dark:border-amber-500/20 overflow-hidden" data-reveal>
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-red-100 to-transparent dark:from-red-900/20 rounded-full -mr-20 -mt-20 group-hover:scale-110 transition-transform duration-300"></div>
                <div className="relative">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 bg-gradient-to-br from-red-500 to-red-700 rounded-lg text-white shadow-lg border border-red-500/30">
                      <Users className="w-6 h-6" />
                    </div>
                    <h3 className="text-2xl font-bold text-[#991b1b] dark:text-amber-100">Sự Gắn kết Chặt chẽ</h3>
                  </div>
                  <p className="text-gray-700 dark:text-red-100/90 text-lg leading-relaxed font-medium mb-4">
                    Quan hệ này được thiết lập trên cơ sở <span className="font-bold text-[#991b1b] dark:text-amber-400">cộng đồng quốc gia – dân tộc thống nhất</span>
                  </p>
                  <div className="bg-red-50 dark:bg-[#3d0e12] p-6 rounded-xl border border-red-100 dark:border-red-900/30">
                    <p className="text-[#991b1b] dark:text-amber-300 font-bold mb-2">👑 Vai trò Tín ngưỡng truyền thống</p>
                    <p className="text-gray-700 dark:text-red-100/80">Tín ngưỡng thờ cúng tổ tiên, Vua Hùng chi phối mạnh mẽ, làm các tôn giáo ngoại nhập phải hòa nhập văn hóa Việt Nam</p>
                  </div>
                </div>
              </div>

              {/* Thách thức */}
              <div className="group relative bg-gradient-to-br from-[#991b1b] to-[#7f1d1d] rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden text-white border border-amber-500/20" data-reveal>
                <div className="relative">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 bg-white/10 rounded-lg border border-white/10">
                      <Zap className="w-6 h-6 text-amber-300" />
                    </div>
                    <h3 className="text-3xl font-bold text-amber-50">Thách thức Mới - Hiện tượng Tôn giáo Mới</h3>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-black/20 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                      <p className="text-2xl mb-3">⚠️</p>
                      <p className="font-semibold mb-2 text-amber-200">Các Hiện tượng</p>
                      <p className="text-red-50/80 text-sm">"Tin Lành Đề Ga", "Hà Mòn"... có tính mê tín, bị lợi dụng tà đạo</p>
                    </div>
                    <div className="bg-black/20 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                      <p className="text-2xl mb-3">🎯</p>
                      <p className="font-semibold mb-2 text-amber-200">Tầm nhìn</p>
                      <p className="text-red-50/80 text-sm">Tăng cường đoàn kết là vấn đề chiến lược, cơ bản, lâu dài và cấp bách</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-white dark:bg-[#2b0a0d] rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-red-100 dark:border-amber-500/20 overflow-hidden" data-reveal>
                <div className="relative">
                  <h3 className="text-3xl font-bold text-[#991b1b] dark:text-amber-100 mb-8">Nguyên tắc "Bất di bất dịch"</h3>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-4 p-4 bg-gradient-to-r from-red-50 to-white dark:from-[#3d0e12] dark:to-[#2b0a0d] rounded-xl hover:shadow-md transition-shadow border border-transparent dark:border-red-900/20">
                        <span className="text-3xl flex-shrink-0">{item.icon}</span>
                        <div className="min-w-0 flex-1">
                          <p className="font-bold text-[#450a0a] dark:text-amber-200 mb-1 break-words">{item.title}</p>
                          <p className="text-gray-700 dark:text-red-100/70 text-sm break-words whitespace-normal">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        {/* Section 3.5: Khái niệm, Vị trí & Chức năng của Gia đình - Đã đổi màu Card */}
        <section id="khai-niem-gia-dinh" className="relative py-24 bg-[#1a0505]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-black mb-4 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
                GIA ĐÌNH: KHÁI NIỆM, VỊ TRÍ & CHỨC NĂNG
              </h2>
              <p className="text-red-200/80 text-lg">Nền tảng của xã hội và tế bào cơ bản của sự phát triển con người</p>
            </div>

            <div className="space-y-8">
              {/* Khái niệm - All in one card */}
              <div className="bg-[#2b0a0d] rounded-2xl p-8 border border-emerald-500/20 hover:bg-[#3d0e12] transition-all" data-reveal>
                <h3 className="text-3xl font-bold text-emerald-400 mb-8">Khái niệm Gia đình</h3>
                
                {/* Two foundations */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                  <div className="bg-[#150505]/60 rounded-xl p-4 border border-emerald-500/10">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-emerald-900/30 flex items-center justify-center">
                        <Heart className="w-4 h-4 text-emerald-400" />
                      </div>
                      <h4 className="text-base font-bold text-emerald-400">Quan hệ Hôn nhân (Vợ - Chồng)</h4>
                    </div>
                    <p className="text-red-100/70 text-xs leading-relaxed">Đây là nền tảng pháp lý, cơ sở đầu tiên để hình thành gia đình và các mối quan hệ khác.</p>
                  </div>
                  ...
                  <div className="bg-[#150505]/60 rounded-xl p-4 border border-emerald-500/10">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h4 className="text-base font-bold text-teal-400">Quan hệ Huyết thống (Cha mẹ - Con cái)</h4>
                    </div>
                    <p className="text-red-100/70 text-xs leading-relaxed">Là quan hệ tự nhiên, mạnh mẽ nhất, gắn kết các thành viên trong gia đình.</p>
                  </div>
                </div>

                {/* Definition */}
                <div className="bg-gradient-to-r from-emerald-900/20 to-teal-900/20 rounded-lg p-6 border border-emerald-500/20">
                  <p className="text-red-100/90 text-center leading-relaxed text-sm">
                    <span className="text-emerald-400 font-semibold">Gia đình là một hình thức cộng đồng xã hội đặc biệt</span>, được hình thành, duy trì và cùng cố chủ yếu dựa trên cơ sở hôn nhân, quan hệ huyết thống và quan hệ nuôi dưỡng, cùng với những quy định về quyền và nghĩa vụ của các thành viên trong gia đình.
                  </p>
                </div>
              </div>

              {/* Vị trí - All in one card */}
              <div className="bg-[#2b0a0d] rounded-2xl p-8 border border-teal-500/20 hover:bg-[#3d0e12] transition-all" data-reveal>
                <h3 className="text-3xl font-bold text-teal-400 mb-8">Vị trí của Gia đình</h3>
                
                <div className="space-y-6">
                  {/* Cell of society */}
                  <div>
                    <h4 className="text-xl font-bold text-emerald-400 mb-3">Gia đình là Tế bào của Xã hội</h4>
                    <div className="space-y-3 text-red-100/80">
                      ...
                      <p className="text-xs text-red-200/60 font-semibold mt-2">Mức độ tác động phụ thuộc vào:</p>
                  ...
                  {/* Warm nest */}
                  <div>
                    <h4 className="text-xl font-bold text-teal-400 mb-3">🏠 Gia đình là Tổ Ấm</h4>
                    <div className="space-y-3 text-red-100/80">
                  ...
                  {/* Bridge */}
                  <div>
                    <h4 className="text-xl font-bold text-cyan-400 mb-3">🌉 Gia đình là Cầu Nối</h4>
                    <div className="space-y-3 text-red-100/80">
                      <div>
                ...
                <div className="space-y-6 text-red-100/80">
                  ...
                  <div>
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <h4 className="text-lg font-bold text-emerald-400">Chức năng Tái sản xuất ra Con người</h4>
                    </div>
                    <p className="text-sm leading-relaxed ml-6">Đây là chức năng đặc thù của gia đình, không một cộng đồng nào có thể thay thế. Chức năng này không chỉ đáp ứng nhu cầu tâm, sinh lý tự nhiên của con người, đáp ứng nhu cầu duy trì nòi giống của gia đình, dòng họ mà còn đáp ứng nhu cầu về sức lao động và duy trì sự trường tồn của xã hội.</p>
                  </div>
                  ...
                  <div>
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <h4 className="text-lg font-bold text-teal-400">Chức năng Nuôi dưỡng, Giáo dục</h4>
                    </div>
                  ...
                  <div>
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <h4 className="text-lg font-bold text-cyan-400">Chức năng Kinh tế & Tổ chức Tiêu dùng</h4>
                    </div>
                    <div className="space-y-2 ml-6 text-sm">
                      <div>
                        <p className="font-semibold text-cyan-300 mb-1">Vai trò sản xuất và tái sản xuất:</p>
                      ...
                      <div>
                        <p className="font-semibold text-cyan-300 mb-1">Chức năng tiêu dùng:</p>
                      ...
                      <div>
                        <p className="font-semibold text-cyan-300 mb-1">Sự biến đổi theo xã hội:</p>
                      ...
                      <div>
                        <p className="font-semibold text-cyan-300 mb-1">Lợi ích:</p>
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed ml-6">Đây là chức năng thường xuyên của gia đình, bao gồm việc thỏa mãn nhu cầu tình cảm, văn hóa, tinh thần cho các thành viên. Sự quan tâm, chăm sóc lẫn nhau giữa các thành viên trong gia đình vừa là nhu cầu tình cảm vừa là trách nhiệm của mỗi người.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed ml-6">Gia đình là nơi lưu giữ truyền thống văn hóa của dân tộc, những phong tục, tập quán, sinh hoạt văn hóa của cộng đồng được thực hiện trong gia đình. Gia đình là cầu nối của mối quan hệ giữa nhà nước với công dân.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Section 4: Gia đình Mới - Đã đổi màu Card */}
        <section id="gia-dinh" className="relative py-24 bg-[#1a0505]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-red-200/80 text-lg">Cơ sở xây dựng gia đình trong thời kỳ quá độ lên CNXH</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="group flex items-start gap-6 p-8 bg-[#2b0a0d] hover:bg-[#3d0e12] rounded-3xl border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 shadow-lg" data-reveal>
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-red-100/70 leading-relaxed font-medium text-sm md:text-base">
                      {item.desc}
                    </p>
                  </div>
                </div>
        ...
        {/* Section: Tình huống Thực tiễn (New) - Đã đổi màu Card */}
        <section id="tinh-huong" className="relative py-24 bg-[#150505]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            <div className="text-center mb-16">
              <Badge className="px-4 py-2 bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 mb-4">CASE STUDY</Badge>
              <h2 className="text-5xl font-black mb-4 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                TÌNH HUỐNG THỰC TIỄN
              </h2>
              <p className="text-red-200/80 text-lg">Quản trị Tôn giáo trong Doanh nghiệp thời kỳ Quá độ</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Bên trái: Tình huống */}
              <div className="space-y-6" data-reveal>
                 <Card className="bg-[#2b0a0d] border-red-500/30 overflow-hidden">
                    <div className="bg-red-900/30 p-4 border-b border-red-500/20 flex items-center gap-3">
                        <AlertTriangle className="text-red-400" />
                        <h3 className="text-xl font-bold text-red-100">Xung đột: Đức tin & Hiệu suất</h3>
                    </div>
                    <CardContent className="p-6 space-y-4">
                        <div className="flex gap-4">
                            <div className="w-12 h-12 rounded-full bg-blue-900/30 flex items-center justify-center flex-shrink-0 border border-blue-500/20">
                                <Briefcase className="text-blue-400" size={20}/>
                            </div>
                            <div>
                                <h4 className="font-bold text-amber-50 mb-1">Nhân vật: Hoàng (HR Manager)</h4>
                                <p className="text-red-100/70 text-sm">Quản lý nhân sự tại tập đoàn dược phẩm đa quốc gia ở vùng giàu truyền thống tôn giáo.</p>
                            </div>
                        </div>

                        <div className="bg-[#150505]/60 p-4 rounded-xl border border-white/5 space-y-3">
                            <p className="text-red-100/80 text-sm italic">"Tôn giáo là chuyện cá nhân, không được phép ảnh hưởng đến năng suất. Chúng ta cần một môi trường 'vô thần' hoàn toàn để vận hành chuyên nghiệp."</p>
                 ...
                 <div className="bg-[#2b0a0d] rounded-2xl p-6 border border-amber-500/20">
                     <h3 className="text-lg font-bold text-amber-100 mb-3">Góc nhìn Mác-Lênin về Nguồn gốc</h3>
                     <ul className="space-y-2">
                        <li className="flex gap-2 text-sm text-red-100/70">
              ...
              {/* Bên phải: Giải pháp */}
              <div className="space-y-6" data-reveal>
                <Card className="bg-[#2b0a0d] border-green-500/30 h-full">
                    ...
                    <CardContent className="p-6 space-y-6">
                        {/* Giải pháp quản trị */}
                        <div>
                            <h4 className="flex items-center gap-2 text-lg font-bold text-amber-50 mb-4">
                        ...
                        <div className="bg-green-900/20 p-4 rounded-xl border border-green-500/20 mt-4">
        ...
        {/* Quiz Section - ĐÃ SỬA MÀU CHỮ VÀ NỀN */}
        <section id="quiz" className="relative py-24 bg-gradient-to-br from-[#7f1d1d] via-[#450a0a] to-[#2b0a0d] overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-amber-500 rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
          </div>
          ...
          <div className="relative z-10 container mx-auto px-4">
            <div className="text-center mb-16">
              <Badge className="px-6 py-3 bg-amber-500/90 text-[#450a0a] text-base font-bold shadow-lg mb-6 border border-amber-300">KIỂM TRA KIẾN THỨC</Badge>
              <h2 className="text-4xl md:text-6xl font-black text-amber-300 mb-4 drop-shadow-lg">
                KIỂM TRA KIẾN THỨC
              </h2>
              <p className="text-lg text-amber-100/80 font-medium">Tôn giáo, Gia đình & Dân tộc trong Thời kỳ Quá độ</p>
            </div>

            <div className="max-w-3xl mx-auto">
              {/* Sửa background Card thành màu tối đậm để làm nổi chữ */}
              <Card className="bg-[#2b0a0d] border-2 border-amber-500/30 shadow-2xl">
                <CardHeader className="bg-gradient-to-r from-[#7f1d1d] to-[#991b1b] text-amber-300 py-6 border-b border-amber-500/20">
                  <CardTitle className="text-2xl font-bold text-center">
                    Câu {currentQuiz + 1} / {quizQuestions.length}
                    <div className="w-full bg-[#450a0a] rounded-full h-2 mt-3">
                      <div 
                        className="bg-gradient-to-r from-amber-400 to-amber-600 h-2 rounded-full transition-all duration-500 shadow-lg" 
                ...
                <CardContent className="p-8">
                  {/* Sửa màu chữ câu hỏi thành màu trắng kem sáng */}
                  <h3 className="text-lg font-bold text-amber-50 mb-8 leading-relaxed">{quizQuestions[currentQuiz].question}</h3>
                        ...
                        className={`w-full text-left justify-start p-5 h-auto text-base transition-all duration-300 font-medium rounded-xl border-2 ${
                          selectedAnswer === index
                            ? index === quizQuestions[currentQuiz].correct
                              ? 'bg-green-700 text-white border-green-500 shadow-lg' // Đúng
                              : 'bg-red-700 text-white border-red-500 shadow-lg' // Sai
                            : 'bg-[#450a0a] text-amber-100 border-amber-500/20 hover:border-amber-500/50 hover:bg-[#5c0e0e]' // Chưa chọn (Đã sửa để hiện chữ)
                        } ${showAnswer && index === quizQuestions[currentQuiz].correct ? 'bg-green-700 text-white border-green-500 shadow-lg' : ''}`}
                      >
                        <span className="mr-4 font-bold bg-[#2b0a0d] text-amber-400 w-8 h-8 rounded-full flex items-center justify-center text-sm flex-shrink-0 border border-amber-500/30">
                  ...
                  {showAnswer && (
                    <div className="mb-8">
                      {selectedAnswer === quizQuestions[currentQuiz].correct ? (
                        <div className="bg-green-900/30 p-6 rounded-xl border-l-4 border-green-500 shadow-lg">
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <p className="text-green-400 font-bold mb-2 text-lg">Chính xác! 🎉</p>
                              <p className="text-green-100/90 text-base leading-relaxed">{quizQuestions[currentQuiz].explanation}</p>
                            </div>
                          </div>
                        </div>
                      ) : (
                        <div className="space-y-4">
                          <div className="bg-red-900/30 p-6 rounded-xl border-l-4 border-red-500 shadow-lg">
                            <div className="flex items-center gap-4">
                              ...
                              <p className="text-red-300 font-bold">Đáp án đúng là: {String.fromCharCode(65 + quizQuestions[currentQuiz].correct)}</p>
                            </div>
                          </div>
                          <div className="bg-blue-900/30 p-6 rounded-xl border-l-4 border-blue-500 shadow-lg">
                            <div className="flex gap-4">
                              ...
                              <p className="text-blue-200 text-base leading-relaxed">{quizQuestions[currentQuiz].explanation}</p>
                            </div>
                          </div>
                        </div>
                      )}
                  ...
                  {showAnswer && (
                    <div className="text-center">
                      {currentQuiz < quizQuestions.length - 1 ? (
                        <Button onClick={nextQuestion} className="bg-gradient-to-r from-amber-500 to-amber-600 text-[#450a0a] hover:from-amber-400 hover:to-amber-500 px-8 py-3 font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                          Câu tiếp theo <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
                      ) : (
                        <div className="space-y-6">
                          <div className="bg-green-900/30 p-8 rounded-xl border-2 border-green-500/50 shadow-lg">
                            <h4 className="text-3xl font-bold text-green-400 mb-3">🎉 Hoàn thành!</h4>
                            <p className="text-5xl font-black text-green-100 mb-2">{correctAnswers}/{quizQuestions.length} câu đúng</p>
                            <p className="text-green-200 text-lg">Bạn đã hoàn thành bộ kiểm tra kiến thức</p>
                          </div>
        ...
        {/* AI Transparency Section - Đã chỉnh về tông tối Tech/Gold */}
        <section id="prove" className="relative bg-[#0a0000] py-24">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-amber-500 rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
          </div>
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-4 mb-8 px-8 py-4 bg-amber-500/10 backdrop-blur-sm rounded-2xl border-2 border-amber-500/30 shadow-lg">
                <span className="text-4xl">🤖</span>
                <span className="text-amber-400 text-lg font-black tracking-wide">TÍNH MINH BẠCH AI</span>
                <span className="text-4xl">📋</span>
              </div>
              
              <h2 className="text-5xl md:text-6xl font-black text-amber-200 mb-6 drop-shadow-lg">
                Công cụ AI trong Học thuật
              </h2>
              <p className="text-xl text-red-100/80 max-w-3xl mx-auto font-medium">
            ...
            <div className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-[#1a0505] backdrop-blur-md rounded-2xl p-8 border border-amber-500/20 shadow-xl hover:shadow-2xl transition-all duration-300">
                  <div className="text-4xl mb-4">🎨</div>
                  <h3 className="text-2xl font-bold text-amber-400 mb-4">Công cụ AI Đã Sử Dụng</h3>
                  <ul className="text-red-100/90 space-y-3 text-lg">
                    <li className="flex items-start gap-3">
                      <span className="text-amber-500 font-bold">•</span>
                      <span><span className="font-bold text-amber-200">DALL-E & Midjourney:</span> Tạo minh họa, icon, texture</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-amber-500 font-bold">•</span>
                      <span><span className="font-bold text-amber-200">Claude & ChatGPT:</span> Hỗ trợ cấu trúc nội dung</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-[#1a0505] backdrop-blur-md rounded-2xl p-8 border border-amber-500/20 shadow-xl hover:shadow-2xl transition-all duration-300">
                  <div className="text-4xl mb-4">✨</div>
                  <h3 className="text-2xl font-bold text-amber-400 mb-4">Mục đích Sử dụng</h3>
                  <ul className="text-red-100/90 space-y-3 text-lg">
                    <li className="flex items-start gap-3">
                      <span className="text-amber-500 font-bold">•</span>
              ...
              <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 backdrop-blur-md rounded-2xl p-8 border border-green-500/20 shadow-xl">
                <h3 className="text-2xl font-bold text-green-400 mb-6 flex items-center gap-3">
                  ...
                  {[
                    ...
                    <div key={i} className="bg-black/20 backdrop-blur-sm rounded-lg p-4 border border-white/10">
        ...
        {/* Footer */}
        <footer className="bg-[#1a0505] border-t-2 border-amber-500/20 py-12">
          <div className="container mx-auto px-4 text-center">
            <div className="mb-4">
              <p className="text-amber-100 text-lg font-semibold mb-2">© 2025 - Tôn giáo, Gia đình, Dân tộc trong Thời kỳ Quá độ</p>
              <p className="text-amber-300 font-medium">Chương 6 & 7 - Thực hành Lý luận Chính trị - MLN131_SE1841_SP26</p>
            </div>
          </div>
        </footer>
        ...
        {showBackTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 bg-gradient-to-br from-amber-400 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-[#450a0a] rounded-full p-5 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-125 z-50 font-bold border-2 border-amber-300 animate-bounce"
